define("bui-tab/1.1.1/index-debug", ["bui-common/1.1.2/common-debug","jquery","bui-menu/1.1.1/index-debug"], function(require, exports, module){
/**
 * @fileOverview 切换标签入口
 * @ignore
 */
...
BUI.mix(Tab, {
  Tab : require("bui-tab/1.1.1/src/tab-debug"),
  TabItem : require("bui-tab/1.1.1/src/tabitem-debug"),
  NavTabItem : require("bui-tab/1.1.1/src/navtabitem-debug"),
  NavTab : require("bui-tab/1.1.1/src/navtab-debug"),
  TabPanel : require("bui-tab/1.1.1/src/tabpanel-debug"),
  TabPanelItem : require("bui-tab/1.1.1/src/tabpanelitem-debug")
});

module.exports = Tab;

});
define("bui-tab/1.1.1/src/tab-debug", ["bui-common/1.1.2/common-debug","jquery"], function(require, exports, module){
/**
 * @fileOverview 切换标签
 * @ignore
 */
...
define("bui-tab/1.1.1/src/tabitem-debug", ["bui-common/1.1.2/common-debug","jquery"], function(require, exports, module){
/**
 * @fileOverview 
 * @ignore
 */
...
define("bui-tab/1.1.1/src/navtabitem-debug", ["jquery","bui-common/1.1.2/common-debug"], function(require, exports, module){
/**
 * @fileOverview 导航项
...
define("bui-tab/1.1.1/src/navtab-debug", ["bui-common/1.1.2/common-debug","jquery","bui-menu/1.1.1/index-debug"], function(require, exports, module){
/**
 * @fileOverview 导航标签
 * @author dxq613@gmail.com
 * @ignore              
...
define("bui-tab/1.1.1/src/tabpanel-debug", ["bui-common/1.1.2/common-debug","jquery"], function(require, exports, module){
/**
...
var BUI = require("bui-common/1.1.2/common-debug"),
  Tab = require("bui-tab/1.1.1/src/tab-debug"),
  Panels = require("bui-tab/1.1.1/src/panels-debug");
...
define("bui-tab/1.1.1/src/panels-debug", ["jquery"], function(require, exports, module){
/**
...
define("bui-tab/1.1.1/src/tabpanelitem-debug", ["bui-common/1.1.2/common-debug","jquery"], function(require, exports, module){
/**
 * @fileOverview 
 * @ignore
 */
...
var BUI = require("bui-common/1.1.2/common-debug"),
  TabItem = require("bui-tab/1.1.1/src/tabitem-debug"),
  PanelItem = require("bui-tab/1.1.1/src/panelitem-debug"),
...
define("bui-tab/1.1.1/src/panelitem-debug", ["jquery"], function(require, exports, module){
/**
